...
interface SMSListItemProps {
  ...
  onLongPress?: (message: SMSMessage) => void;
  isSelectionMode?: boolean;
  isSelected?: boolean;
  onToggleSelect?: (message: SMSMessage) => void;
  isAd?: boolean;
}

export const SMSListItem = React.memo(function SMSListItem({
  message,
  timeDisplay = '',
  onPress,
  onLongPress,
