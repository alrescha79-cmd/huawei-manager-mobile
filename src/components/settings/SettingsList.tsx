...
export const SettingsSection = ({ title, children, style }: SettingsSectionProps) => {
  ...
  return (
    <View style={[styles.sectionWrapper, style]}>
      {title && (
        <Text style={[styles.sectionTitle, typography.caption1, { color: colors.primary }]}>
          {title}
        </Text>
      )}
      <View
...
export const SettingsItem = ({
  ...
  return (
    <Wrapper style={[styles.itemTouchable]} {...wrapperProps}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              {value && (
                <Text
                  style={[
                    typography.body,
                    { color: colors.textSecondary, marginRight: showChevron ? 4 : 0 },
                  ]}
                >
                  {value}
                </Text>
