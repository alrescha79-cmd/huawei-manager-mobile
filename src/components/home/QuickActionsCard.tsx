...
export const QuickActionsCard = React.memo(function QuickActionsCard({
  ...
  return (
    ...
    >
      ...
      {/* 4x2 grid - Small actions with thin background */}
      <View style={[styles.quickGrid, { backgroundColor: itemBg, borderColor: itemBorder }]}>
        <View style={styles.bottomRow}>
          {/* Lokasi BTS */}
          <TouchableOpacity style={styles.smallAction} onPress={onBtsLocator} activeOpacity={0.7}>
            <View
              style={[
          ...
          {/* Speed Test */}
          <TouchableOpacity style={styles.smallAction} onPress={onSpeedtest} activeOpacity={0.7}>
            <View
              style={[
                styles.smallIconCircle,
                {
        ...
        <View style={[styles.bottomRow, styles.bottomRowSpaced]}>
          ...
          >
            ...
            >
              <MaterialIcons
                name="data-usage"
                size={16}
                color={monthlySettings?.enabled ? '#eeeeee' : colors.primary}
              />
            </View>
            <View style={styles.smallActionTextContainer}>
              <TextTicker
          ...
          {/* Theme Toggle */}
          <TouchableOpacity style={styles.smallAction} onPress={onToggleTheme} activeOpacity={0.7}>
            <View
              style={[
                styles.smallIconCircle,
                {
