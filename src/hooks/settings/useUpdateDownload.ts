      ...
      if (result && result.uri) {
        ...
        if (!launched) {
          ThemedAlertHelper.alert(
            ...
            t('settings.downloadComplete') ||
              'Update downloaded successfully. Please open and install the APK file manually, or open the link in your browser.',
            [
              { text: t('common.ok') || 'OK', style: 'cancel' },
              {
                text: t('settings.downloadUpdate') || 'Open Browser',
        ...
        ThemedAlertHelper.alert(
          ...
          t('settings.downloadFailed') ||
            'Failed to download or install update. Please try again or download manually.',
          [
            { text: t('common.ok') || 'OK', style: 'cancel' },
            {
              text: t('settings.downloadUpdate') || 'Open Browser',
