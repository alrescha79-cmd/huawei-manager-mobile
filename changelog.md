...
## v1.1.75
- **BTS Locator Feature** Added a dedicated interactive BTS Locator map to find the connected cell tower and visualize nearby 2G (GSM), 3G (UMTS), 4G (LTE), and 5G (NR) towers within a 20 km radius.
...
## v1.1.75
- **Fitur Baru BTS Locator** Menambahkan peta interaktif BTS Locator untuk melacak posisi menara BTS yang sedang terhubung serta menampilkan persebaran BTS 2G (GSM), 3G (UMTS), 4G (LTE), dan 5G (NR) terdekat dalam radius 20 km.
